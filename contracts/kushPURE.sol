...
contract kushPUREToken is ERC20{
    ...
    function stakekushPUREUni(uint256 amount) public updateStakingReward(msg.sender) {
    ...
    function withdrawkushPUREUni(uint256 amount) public updateStakingReward(msg.sender) {
    ...
    function getkushPUREUniStakeAmount(address _account) public view returns (uint256) {
