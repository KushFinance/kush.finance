...
abstract contract ERC20Interface {
  function balanceOf(address whom) public virtual view returns (uint256);
}

contract kSEEDGovernance is ERC20 {
  ...
  constructor(address _kseedAddress) public ERC20('kSEEDGovernance', 'KSEED') {
    currentAdmins[msg.sender].isAdmin = true;
    kseedAddress = _kseedAddress;
    kseedIERC20 = IERC20(kseedAddress);
  }

  function getkSeedBalance() public view returns (uint256) {
    return ERC20Interface(kseedAddress).balanceOf(msg.sender);
  }
