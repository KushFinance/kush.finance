  ...
  render() {
    return (
      <div className="subpage govern">
        ...
        <p> The contract will hold the token for a specified amount of blocks or until kSEED holders vote for a swap back to KUSH</p>
        <p> During a swap back to KUSH, the resulting KUSH will be proportionately distributed to kSEED holders.</p>
