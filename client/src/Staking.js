      ...
      <div className="modal">
        <div className="modal_content">
          ...
          <div className="amount-staked-box">
            ...
            <br />
            {!this.state.isApproved ? <Button type="primary" className="button stake-button" onClick={this.approvekSeed}>
                {!this.state.isApproving ? <div>STEP 1/2: APPROVE</div> : null}
                {this.state.isApproving ? <div>APPROVING...</div> : null}
            </Button> : null}
            {this.state.isApproved ? <Button type="primary" className={`button stake-button ${this.state.stakeAmount > 0 && this.state.stakeAmount < this.state.kseedBalance ? "" : "disabled"}`} onClick={this.stakekSeed}>
